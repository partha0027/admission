        ...
        function (t) {
                        ...
                        if (!1 === s)
                            ...
                            if (
                                ...
                                if ("map" === t.type) t.validateNow(!0), d();
                                    ...
                                    if ("stock" === t.type) {
                                        t.panelsSettings.startDuration =
                                            c.startDuration;
                                        for (
                                            var p = 0;
                                            p < t.panels.length;
            ...
            function a(e, a) {
                ...
                try {
                    ...
                    return (
                        i(
                            AmCharts.__("Error loading file", t.language) +
                                ": " +
                                a.url,
                            !1,
                            a
            ...
            function s(e, a) {
                d(),
                    void 0 === e &&
                        (e = AmCharts.__("Loading data...", t.language));
            ...
            function d() {
                try {
                    void 0 !== c.curtain &&
                        t.containerDiv.removeChild(c.curtain);
                } catch (t) {}
                c.curtain = void 0;
            }
            function l(t, e, a, r) {
            ...
            if (
                !(Number(u[0]) < 3 || (3 === Number(u[0]) && Number(u[1]) < 13))
            ) {
                var c = t.dataLoader;
                ...
                (c.loadData = function () {
                    if ("stock" === t.type)
                        ...
                        void 0 !== t.startDuration &&
                            0 < t.startDuration &&
                            ((c.startDuration = t.startDuration),
                            (t.startDuration = 0)),
                            "gauge" === t.type
