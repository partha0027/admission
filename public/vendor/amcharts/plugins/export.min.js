                ...
                d = {
                        ...
                        handler: {
                            ...
                            line: function (c) {
                                ...
                                for (f = 0; f < u.group.length; f++)
                                    (u.group[f].ignoreUndo = !0),
                                        d.setup.fabric.add(u.group[f]);
                                return u;
                            },
                        },
                    },
                    ...
                    loadResource: function (c, u) {
                        ...
                        for (
                            ...
                            if (
                                ...
                                d.libs.reload && document.head.removeChild(S),
                                    (w = !0);
                                break;
                            }
                        ...
                        if (d.libs.autoLoad)
                            for (c = 0; c < d.libs.resources.length; c++)
                                d.libs.resources[c] instanceof Object
                                    ? Object.keys(d.libs.resources[c]).some(
                                          function (f) {
                                              d.loadResource(
                                                  f,
                                                  d.libs.resources[c][f]
                                              );
                                          }
                                      )
                    ...
                    removeImage: function (c) {
                        if (c) {
                            ...
                            if (d.config.fabric.removeImages && d.isTainted(c))
                                return !0;
                            if (
                                d.setup.isIE &&
                    ...
                    capture: function (c, u) {
                        ...
                        if (d.config.legend) {
                            ...
                            for (f = 0; f < S.items.length; f++) {
                                var M = S.items[f],
                                    A = {
                                        ...
                                        parent: M.container.container
                                            .parentNode,
                                        children:
                                            M.container.container.getElementsByTagName(
                                                "*"
                                            ),
                                        offset: { x: 0, y: 0 },
                                        legend: {
                            ...
                            -1 ==
                            ["top", "bottom"].indexOf(d.config.legend.position)
                                ? -1 ==
                                  ["left", "right"].indexOf(
                                      d.config.legend.position
                                  )
                        ...
                        if (
                            ((d.drawing.enabled = h.drawing.enabled =
                                "draw" == h.action),
                            ...
                            d.setup.chart.leftContainer &&
                                ...
                                (d.setup.wrapper.style.paddingRight =
                                    d.numberToPx(F.right)),
                                (d.setup.wrapper.style.paddingBottom =
                                    d.numberToPx(F.bottom)),
                            ...
                            d.setup.fabric = new fabric.Canvas(
                                ...
                                d.setup.fabric.on("object:added", function (E) {
                                    ...
                                    return (
                                        ...
                                        d.drawing.buffer.ignoreUndoOnMouseUp ||
                                        !d.drawing.buffer.isDrawing
                                            ? void (d.drawing.buffer.ignoreUndoOnMouseUp =
                                                  !1)
                                            : void (I.selectable &&
                                                  !I.known &&
                                                  !I.ignoreUndo &&
                            ...
                            d.setup.chart.legendSettings.position
                                ? -1 ==
                                  ["top", "bottom"].indexOf(
                                    ...
                                    ? -1 !=
                                          ["left", "right"].indexOf(
                                              d.setup.chart.legendSettings
                                                  .position
                                          ) &&
                                      ((A.offset.y =
                                          d.pxToNumber(A.parent.style.top) +
                                          w.pY),
                                      (A.offset.x =
                                          d.pxToNumber(A.parent.style.left) +
                                          w.pX),
                                      A.has.legend
                                          ? (w.pY +=
                                                d.pxToNumber(
                                                    A.has.panel.style.height
                                                ) +
                                                d.setup.chart.panelsSettings
                                                    .panelSpacing)
                                          : A.has.scrollbar &&
                                    ...
                                    ? ((A.offset.y = d.pxToNumber(
                                          A.parent.style.top
                                      )),
                                      (A.offset.x = d.pxToNumber(
                                          A.parent.style.left
                                      )))
                                    : ((A.offset.x = w.x),
                                      (A.offset.y = w.y),
                                      (w.y += d.pxToNumber(
                                          A.parent.style.height
                                      )),
                                      A.has.panel
                                          ? ((w.pY = d.pxToNumber(
                                                A.has.panel.style.marginTop
                                            )),
                                            (A.offset.y += w.pY))
                                          : A.has.scrollbar &&
                                            (A.offset.y += w.pY))
                                : ("absolute" == A.parent.style.position
                                      ? ((A.offset.absolute = !0),
                                        (A.offset.top = d.pxToNumber(
                                            A.parent.style.top
                                        )),
                                        (A.offset.right = d.pxToNumber(
                                            A.parent.style.right,
                                            !0
                                        )),
                                        ...
                                        (A.offset.left = d.pxToNumber(
                                            A.parent.style.left
                                        )),
                                        (A.offset.width = d.pxToNumber(
                                            A.parent.style.width
                                        )),
                                        (A.offset.height = d.pxToNumber(
                                            A.parent.style.height
                                        )))
                                      : A.parent.style.top &&
                                        A.parent.style.left
                                    ...
                                    (function (E) {
                                        return function (I, P) {
                                            ...
                                            if (
                                                ...
                                                var W =
                                                    E.svg.parentNode.getElementsByClassName(
                                                        d.setup.chart
                                                            .classNamePrefix +
                                                            "-balloon-div"
                                                    );
                                                for (O = 0; O < W.length; O++)
                                                    if (
                                                        h.balloonFunction instanceof
                                                        Function
                                                    )
                                                        h.balloonFunction.apply(
                                                            d,
                                                            [W[O], E]
                                                        );
                                                    else {
                    ...
                    toSVG: function (c, u) {
                        ...
                        if (
                            ...
                            return !1;
                        if (
                            ((w = d.setup.fabric.toSVG(m, m.reviver)), f.length)
                        ) {
                        ...
                        return (
                            ...
                            m.getBase64 &&
                                (w = "data:image/svg+xml;base64," + btoa(w)),
                    ...
                    toJSON: function (c, u) {
                        ...
                        return (
                            ...
                            ((f.data =
                                void 0 === f.data ? d.getChartData(f) : f.data),
                    ...
                    toXLSX: function (c, u) {
                        function f(T, A) {
                            ...
                            return (
                                (M - F - new Date(Date.UTC(1899, 11, 30))) /
                                86400000
                            );
                        }
                        var m = d.deepMerge(
                    ...
                    handleBorder: function (c) {
                        if (d.config.border instanceof Object) {
                            ...
                            (u.width = d.setup.fabric.width - u.strokeWidth),
                                (u.height =
                                    d.setup.fabric.height - u.strokeWidth),
                                f.set(u),
                                d.setup.fabric.add(f);
                        }
                    },
                        ...
                        if (0 == f.data.length)
                            if ("stock" == d.setup.chart.type) {
                                for (
                                    ...
                                    for (
                                        w = 0;
                                        w < d.setup.chart.panels.length;
                                        w++
                                    ) {
                                        var M = d.setup.chart.panels[w];
                                        for (
                                            N = 0;
                                            N < M.stockGraphs.length;
                                            N++
                                        ) {
                                ...
                                if (d.setup.chart.comparedGraphs.length) {
                                    ...
                                    for (
                                        m = 0;
                                        m < d.setup.chart.comparedGraphs.length;
                                        m++
                                    ) {
                                        var F = d.setup.chart.comparedGraphs[m];
                                        for (
                                            w = 0;
                                            w < F.dataSet.dataProvider.length;
                                            w++
                                        ) {
                                            var D = F.dataSet.categoryField,
                                                E =
                                                    F.dataSet.dataProvider[w][
                                                        D
                                                    ],
                                                I = T.indexOf(E);
                                            if (-1 != I)
                                ...
                                for (
                                    m = 0;
                                    m < d.setup.chart.dataProvider.length;
                                    m++
                                ) {
                        ...
                        return (
                            fabric.util.enlivenObjects(f.data, function (h) {
                                h.forEach(function (m, w) {
                                    d.handleCallback(f.reviver, m, w),
                                        d.setup.fabric.add(m);
                                }),
                    ...
                    processData: function (c) {
                        ...
                        if (u.data.length) {
                            ...
                            void 0 !== u.exportFields &&
                                (u.dataFields = u.exportFields.filter(function (
                                    F
                                ) {
                            ...
                            for (S = 0; S < w.length; S++) {
                                ...
                                if ("draw" == M.action)
                                    ...
                                    M.click ||
                                        M.menu ||
                                        M.items ||
                                        (d.drawing.handler[P] instanceof
                                        Function
                                            ? ((M.action = P),
                                              (M.click = (function (H) {
                                                  return function () {
                                ...
                                (void 0 === M.menu || M.menu.length) &&
                                    ...
                                    d.config.menuReviver &&
                                        (F = d.config.menuReviver.apply(d, [
                                            M,
                                            F,
                                        ])),
                                    (M.elements = {
                                    ...
                                    (M.menu || M.items) && "draw" != M.action
                                        ? f(M.menu || M.items, F).childNodes
                                              .length && A.appendChild(F)
                                        : A.appendChild(F));
                            }
                    ...
                    clear: function () {
                        var c, u;
                        for (
                            void 0 !== d.setup.fabric &&
                                d.setup.fabric.removeListeners(),
                                c = 0;
                        ...
                        d.isElement(d.setup.wrapper) &&
                            ...
                            d.isElement(d.setup.menu) &&
                                d.isElement(d.setup.wrapper.parentNode) &&
                                d.setup.wrapper.parentNode.removeChild &&
                                d.setup.menu.parentNode.removeChild(
                                    d.setup.menu
                                ),
                            (d.listenersToRemove = []),
