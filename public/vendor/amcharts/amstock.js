    ...
    e.AmStockChart = e.Class({
        ...
        afterWrite: function (a) {
            ...
            this.zoomOutOnDataSetChange &&
                (this.endDate = this.startDate = void 0);
        ...
        updateDataSets: function () {
            ...
            for (c = 0; c < b.length; c++) {
                ...
                b[c] = d;
                d.id ||
                    (this.dataSetCount++, (d.id = "ds" + this.dataSetCount));
                void 0 === d.color &&
                    (d.color =
                        this.colors.length - 1 > c
                            ? this.colors[c]
                            : e.randomColor());
            }
                ...
                for (q = 0; q < t; q++) {
                    ...
                    for (z = f; z < m; z++) {
                        ...
                        if (z == f || C >= y[p] || !y[p]) {
                            ...
                            for (
                                w = v[p], w.rawData && w.rawData.push(B), p = 0;
                                p < E;
                                p++
                            )
                                (u = A[p].toField),
            ...
            for (n = 0; n < h; n++) {
                ...
                for (f = 0; f < m; f++)
                    (q = t[f]),
                        ...
                        (q.bulletConfigField =
                            "amCustomBulletConfig" + q.id + "_" + p.id),
                        (q.chart = p);
                ...
                if (c != this.prevPH) {
                    ...
                    for (var d = 0, g, b = 0; b < a.length; b++)
                        if ((g = a[b])) {
                            ...
                            isNaN(l) &&
                                ((l = 100 / a.length), (g.percentHeight = l));
                            d += l;
                        }
        ...
        handleCursorChange: function (a) {
            ...
            for (c = 0; c < b.length; c++) {
                var d = b[c];
                d != a &&
                    d.syncWithCursor(a, this.chartCursorSettings.onePanelOnly);
            }
        },
        handleCursorZoom: function (a) {
            ...
            if (this.categoryAxesSettings.equalSpacing) {
                ...
                var e =
                    this.mainDataSet.agregatedDataProviders[this.currentPeriod];
        ...
        zoomChart: function (a, b) {
            ...
            if (k && g) {
                ...
                for (k = 0; k < q.length; k++)
                    (g = q[k]),
                        g.chartCursor && g.chartCursor.panning && (v = d);
                for (k = 0; k < q.length; k++) {
                    g = q[k];
                    d = !1;
                    if (l != h) {
                        for (d = 0; d < t.length; d++)
                            (A = t[d].graph),
                                (A.dataProvider =
                                    A.dataSet.agregatedDataProviders[l]);
                        d = g.categoryAxis;
                        d.firstDayOfWeek = y;
                        d.minPeriod = l;
                        g.dataProvider =
                            c.mainDataSet.agregatedDataProviders[l];
                        if ((d = g.chartCursor))
                            (d.categoryBalloonDateFormat =
                                c.chartCursorSettings.categoryBalloonDateFormat(
                                    n.period
                                )),
                                g.showCategoryAxis ||
                                    (d.categoryBalloonEnabled = !1);
            ...
            if (0 < this.dataSets.length) {
                ...
                for (b = 0; b < a.length; b++) {
                    ...
                    for (l = 0; l < g.length; l++) {
                        ...
                        if (f.comparable) {
                            ...
                            if (f.valueAxis) {
                                0 < B &&
                                    ...
                                    ((f.valueAxis.logarithmic = !1),
                                    (f.valueAxis.prevLog = !0));
                                0 < B &&
                                    "whenComparing" ==
                                        c.recalculateToPercents &&
                                ...
                                for (D = 0; D < B; D++) {
                                    ...
                                    z || (z = f.valueField);
                                    r.customBulletsHidden =
                                        !f.showEventsOnComparedGraphs;
                                    m = !1;
                                    q = C.fieldMappings;
                                    for (h = 0; h < q.length; h++)
                                    ...
                                    if (m) {
                                        ...
                                        if (
                                            (h =
                                                f.compareGraphNegativeFillColors)
                                        )
                                        ...
                                        if (
                                            (h =
                                                f.compareGraphNegativeFillAlphas)
                                        )
                        ...
                        p &&
                            (t && y
                                ? ((f.legendValueTextR = y),
                                  (f.legendPeriodValueTextR = A))
        ...
        choosePeriod: function (a, b, c) {
            ...
            d.alwaysGroup &&
                g == d.minPeriod &&
                (g = 1 < k.length ? k[1] : k[0]);
            return (f - n) / h > m && 0 < m && l
        ...
        showHideEvents: function (a) {
            ...
            for (c = 0; c < b.length; c++) {
                ...
                for (e = 0; e < d.length; e++) {
                    var g = d[e];
                    !0 === a
                        ? g.showCustomBullets(!0)
                        : g.hideCustomBullets(!0);
                }
            }
        },
    ...
    e.PeriodSelector = e.Class({
        ...
        zoom: function (a, b) {
            ...
            this.inputFieldsEnabled &&
                ((this.startDateField.value = e.formatDate(
                    a,
                    this.dateFormat,
                    c
                )),
                (this.endDateField.value = e.formatDate(
                    b,
                    this.dateFormat,
                    c
                )));
        ...
        write: function (a) {
            var b = this,
                ...
                d = c.classNamePrefix;
            a.className =
                "amChartsPeriodSelector " + d + "-period-selector-div";
            var k = b.width,
                g = b.position;
            b.width = void 0;
            b.position = void 0;
            ...
            a.innerHTML =
                ...
                (c.langObj.periodSelectorAccessibilityText ||
                    b.accessibilityText) +
                "</legend></fieldset>";
            var l = a.firstChild;
            a = b.theme;
            ...
            if (e.ifArray(n)) {
                ...
                c = document.createTextNode(
                    c.langObj.periodsText || b.periodsText
                );
                f.appendChild(c);
                b.periodContainer = f;
        ...
        handleCalChange: function (a) {
            var b = this.dateFormat,
                ...
                b = this.chart.getLastDate(
                    e.stringToDate(this.endDateField.value, b)
                );
            try {
            ...
            f &&
                ...
                ("MAX" == g
                    ...
                    ? (e.getPeriodDuration(g, k),
                      ...
                      h
                          ? ((h = f),
                            n.setMilliseconds(f.getMilliseconds() - q + 1))
                ...
                h.getTime() > m.getTime() &&
                    ((q = e.getPeriodDuration("DD", 1)),
                    (h = new Date(m.getTime() - q))),
        ...
        unselectButtons: function () {
            ...
            for (c = b.length - 1; 0 <= c; c--) {
                var k = b[c].button;
                k.className =
                    "amChartsButton " + a.classNamePrefix + "-period-input";
...
(function () {
    ...
    e.CategoryAxesSettings = e.Class({
        construct: function (a) {
            ...
            this.maxSeries = 150;
            this.groupToPeriods =
                "ss 10ss 30ss mm 10mm 30mm hh DD WW MM YYYY".split(" ");
    ...
    e.DataSetSelector = e.Class({
        ...
        write: function (a) {
            ...
            if (1 < b.countDataSets("showInSelect")) {
                c = document.createTextNode(
                    k.langObj.selectText || b.selectText
                );
                a.appendChild(c);
                l && e.addBr(a);
                ...
                for (c = 0; c < g.length; c++)
                    if (((n = g[c]), !0 === n.showInSelect)) {
                        ...
                        f.className =
                            k.classNamePrefix + "-data-set-select-option";
                        f.text = n.title;
                        f.value = c;
                ...
                if (
                    (l
                        ...
                        : ((c = document.createTextNode(" ")),
                          a.appendChild(c)),
                    (c = document.createTextNode(
                        k.langObj.compareText || b.compareText
                    )),
                    a.appendChild(c),
                    ...
                    for (c = 0; c < g.length; c++)
                        (n = g[c]),
                            !0 === n.showInCompare &&
                                ...
                                (d.className =
                                    k.classNamePrefix + "-compare-item-div"),
                                (d.dataSet = n),
                                (d.style.height = f + "px"),
                                n.compared &&
                    ...
                    f = document.createElement("option");
                    f.text =
                        k.langObj.comboBoxSelectText || b.comboBoxSelectText;
                    try {
                        d.add(f, null);
                    } catch (q) {
                        d.add(f);
                    ...
                    for (c = 0; c < g.length; c++)
                        if (
                            ((n = g[c]),
                            !0 === n.showInCompare && n != b.chart.mainDataSet)
                        ) {
                            f = document.createElement("option");
                            f.text = n.title;
                            f.value = c;
        ...
        handleCBSelect: function (a) {
            ...
            for (d = 0; d < c.length; d++)
                (e = c[d]),
                    e.compared &&
                        (a = { type: "dataSetUncompared", dataSet: e }),
                    (e.compared = !1);
            c = b.selectedIndex;
            0 < c &&
        ...
        handleClick: function (a) {
            ...
            !0 === a.compared
                ? ((a.compared = !1),
                  (a = { type: "dataSetUncompared", dataSet: a }))
                : ((a.compared = !0),
                  (a = { type: "dataSetCompared", dataSet: a }));
            var b = this.chart;
            b.validateData(!0);
            a.chart = b;
            this.fire(a);
    ...
    e.StackedBullet = e.Class({
        ...
        addLetter: function (a, b, c) {
            ...
            this.showOnAxis
                ...
                : this.value
                ? ((m = this.value),
                  l.recalculateToPercents &&
                      (m = (m / l.recBaseValue) * 100 - 100),
