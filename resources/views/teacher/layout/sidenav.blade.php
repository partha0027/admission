    ...
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{ route('allteacher') }}">All Teachers</a></li>
                    <li><a href="{{ route('addteacher') }}">Add Teachers</a></li>
                    <li><a href="{{ route('editTeacher') }}">Edit Teachers</a></li>
                    <li><a href="professor-profile.html">Teachers Profile</a></li>
                </ul>
            </li>
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
