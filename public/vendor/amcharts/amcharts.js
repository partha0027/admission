    ...
    d.wordwrap = function (a, b, c, e) {
        ...
        for (a = (k = a.split(/\r\n|\n|\r/)).length; ++g < a; k[g] += h) {
            ...
            for (
                ...
                h.length > b;
                k[g] +=
                    d.trim(h.slice(0, f)) + ((h = h.slice(f)).length ? c : "")
            )
                f =
...
(function () {
    ...
    d.AxisBase = d.Class({
        ...
        addGuide: function (a) {
            for (
                var b = this.guides, c = !1, e = b.length, g = 0;
                g < b.length;
                g++
            )
                b[g] == a && ((c = !0), (e = g));
            ...
            if (0 < this.gridCountR)
                for (
                    ...
                    "MM" == A &&
                        ...
                        1.5 <= (p - l) / y &&
                            ((p =
                                p - (g - 1) * y + d.getPeriodDuration("DD", 3)),
...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, g, f, h, k, l, m, n, q) {
            ...
            h
                ? (void 0 !== h.id &&
                      (q = p.classNamePrefix + "-guide-" + h.id),
                  (P = !0),
...
(function () {
    ...
    d.RecFill = d.Class({
        construct: function (a, b, c, e) {
            ...
            0 > c &&
                "object" == typeof n &&
                (n = n.join(",").split(",").reverse());
            "V" == h
                ? ((h = d.rect(l, a.width, c, n, m)), h.translate(g, b - k + f))
                : ((h = d.rect(l, c, a.height, n, m)),
                  h.translate(b - k + g, f));
    ...
    d.SimpleChartScrollbar = d.Class({
        ...
        clipDragger: function (a) {
            ...
            if (b) {
                ...
                a &&
                    (this.updateOnReleaseOnly || this.dispatchScrollbarEvent());
            }
        },
        maskGraphs: function () {},
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    var h = this.l,
                        ...
                        t = q;
                    void 0 != n &&
                        (this.adjustBorderColor ? (t = p = n) : (q = n));
                    ...
                    var I = n.offsetWidth,
                        H = n.offsetHeight;
                    n.clientHeight &&
                        ((I = n.clientWidth), (H = n.clientHeight));
                    A = H + 2 * w;
                    C = I + 2 * r;
                    !isNaN(D) && C < D && (C = D);
                    window.opera && (A += 2);
                    ...
                    this.drop
                        ? ((h = C / 1.6),
                          ...
                          "up" == x &&
                              ((l = 180), (D = a + 1), (y = b + h + h / 3)),
                          "left" == x &&
                              ((l = 270), (D = a + h + h / 3 + 2), (y = b)),
                          "right" == x &&
                              ((l = 90), (D = a - h - h / 3 + 2), (y = b)),
                          (k = y - H / 2 + 1),
                          (m = D - I / 2 - 1),
            ...
            for (
                ...
                null !== m &&
                    ...
                    "date" == b.valueAxis.type &&
                        void 0 !== m &&
                        ((g = d.getDate(m, b.chart.dataDateFormat)),
                        (e[l] = g.getTime())));
            }
            return e;
        },
